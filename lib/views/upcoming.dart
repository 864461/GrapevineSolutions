...
import 'package:grapevine_solutions/views/myShiftCard.dart';
import 'package:intl/intl.dart';


// ignore: camel_case_types
class myUpcoming extends StatefulWidget {
  // Shifts({this.onSignedOut});
  // final VoidCallback onSignedOut;

  @override upComing createState() => upComing();
}

// ignore: camel_case_types
class upComing extends State<myUpcoming>{
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        children: <Widget>[
          SizedBox(height: 40),
          Text("Search Upcoming  ", style: TextStyle(fontSize: 20)),
          Padding(
            padding:
          ...
          Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) =>
                    MyShiftCard(context, _resultsList[index]),
              )),
        ],
      ),
    );
