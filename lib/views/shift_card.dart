...
Widget shiftCard(BuildContext context,DocumentSnapshot document){
...
void showAlertDialog(BuildContext context,hospital,date,time,id) {
  showDialog(
      context: context,
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  MaterialButton(
                                    ...
                                    onPressed: () {
                                      showAlertDialog(context,shift.hospital,shift.date,shift.time,shift.time);
                                  // showDialog(
                                  // context: context,
